import { __commonJS } from './chunk-UV5CTPV7.js';
...
var require_redux_logger = __commonJS({
    'node_modules/redux-logger/dist/redux-logger.js'(exports, module) {
        !(function (e, t) {
            ...
            function t(e2, t2) {
                (e2.super_ = t2),
                    (e2.prototype = Object.create(t2.prototype, {
                        constructor: { value: e2, enumerable: false, writable: true, configurable: true }
                    }));
            }
            function r(e2, t2) {
                Object.defineProperty(this, 'kind', { value: e2, enumerable: true }),
                    t2 && t2.length && Object.defineProperty(this, 'path', { value: t2, enumerable: true });
            }
            function n(e2, t2, r2) {
                n.super_.call(this, 'E', e2),
                    Object.defineProperty(this, 'lhs', { value: t2, enumerable: true }),
                    Object.defineProperty(this, 'rhs', { value: r2, enumerable: true });
            }
            function o(e2, t2) {
            ...
            function a(e2, t2, r2) {
                a.super_.call(this, 'A', e2),
                    Object.defineProperty(this, 'index', { value: t2, enumerable: true }),
                    Object.defineProperty(this, 'item', { value: r2, enumerable: true });
            }
            function f(e2, t2, r2) {
                      ...
                      : null === e2
                        ...
                        : Array.isArray(e2)
                          ...
                          : '[object Date]' === Object.prototype.toString.call(e2)
                            ? 'date'
                            : 'function' == typeof e2.toString && /^\/.*\//.test(e2.toString())
                              ? 'regexp'
                              : 'object';
            }
            function l(e2, t2, r2, c2, s2, d2, p2) {
                ...
                var y2 = 'undefined' == typeof e2 ? 'undefined' : N(e2),
                    v2 = 'undefined' == typeof t2 ? 'undefined' : N(t2),
                    b2 =
                        'undefined' !== y2 || (p2 && p2[p2.length - 1].lhs && p2[p2.length - 1].lhs.hasOwnProperty(d2)),
                    m2 =
                        'undefined' !== v2 || (p2 && p2[p2.length - 1].rhs && p2[p2.length - 1].rhs.hasOwnProperty(d2));
                    ...
                    if (
                        ...
                        if ((p2.push({ lhs: e2, rhs: t2 }), Array.isArray(e2))) {
                            ...
                            for (w2 = 0; w2 < e2.length; w2++)
                                w2 >= t2.length
                                    ? r2(new a(g2, w2, new i(void 0, e2[w2])))
                                    : l(e2[w2], t2[w2], r2, c2, g2, w2, p2);
                            for (; w2 < t2.length; ) r2(new a(g2, w2, new o(void 0, t2[w2++])));
                        } else {
                            var x2 = Object.keys(e2),
                                S2 = Object.keys(t2);
                            x2.forEach(function (n2, o2) {
                                var i2 = S2.indexOf(n2);
                                i2 >= 0
                                    ? (l(e2[n2], t2[n2], r2, c2, g2, n2, p2), (S2 = f(S2, i2)))
                                    : l(e2[n2], void 0, r2, c2, g2, n2, p2);
                            }),
            ...
            function d(e2, t2, r2) {
                if (e2 && t2 && r2 && r2.kind) {
                    for (var n2 = e2, o2 = -1, i2 = r2.path ? r2.path.length - 1 : 0; ++o2 < i2; )
                        'undefined' == typeof n2[r2.path[o2]] &&
                            (n2[r2.path[o2]] = 'number' == typeof r2.path[o2] ? [] : {}),
                            (n2 = n2[r2.path[o2]]);
                    switch (r2.kind) {
                        case 'A':
            ...
            function w(e2) {
                ...
                return function (e3, n2, o2) {
                    var i2 = ['action'];
                    return (
                        i2.push('%c' + String(e3.type)),
                        t2 && i2.push('%c@ ' + n2),
                        r2 && i2.push('%c(in ' + o2.toFixed(2) + ' ms)'),
                        i2.join(' ')
                    );
                };
            }
            function x(e2, t2) {
                var r2 = t2.logger,
                    n2 = t2.actionTransformer,
                    o2 = t2.titleFormatter,
                    i2 = void 0 === o2 ? w(t2) : o2,
                    a2 = t2.collapsed,
                    f2 = t2.colors,
                    u2 = t2.level,
                    l2 = t2.diff,
                    c2 = 'undefined' == typeof t2.titleFormatter;
                    ...
                    var S2 = n2(g2),
                        k2 =
                            'function' == typeof a2
                                ...
                                : a2,
                        j2 = D(p2),
                        E2 = f2.title ? 'color: ' + f2.title(S2) + ';' : '',
                        A2 = ['color: gray; font-weight: lighter;'];
                    A2.push(E2),
                        t2.timestamp && A2.push('color: gray; font-weight: lighter;'),
                        t2.duration && A2.push('color: gray; font-weight: lighter;');
                    var O2 = i2(S2, j2, v2);
                    try {
                        k2
                            ? f2.title && c2
                                ? r2.groupCollapsed.apply(r2, ['%c ' + O2].concat(A2))
                                : r2.groupCollapsed(O2)
                            : f2.title && c2
                              ? r2.group.apply(r2, ['%c ' + O2].concat(A2))
                              : r2.group(O2);
                    } catch (e3) {
                        r2.log(O2);
                    }
                    var N2 = m(u2, S2, [h2], 'prevState'),
                        P2 = m(u2, S2, [S2], 'action'),
                        C2 = m(u2, S2, [y2, h2], 'error'),
                        F2 = m(u2, S2, [w2], 'nextState');
                    if (N2)
                        if (f2.prevState) {
            ...
            function S() {
                var e2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    t2 = Object.assign({}, L, e2),
                    r2 = t2.logger,
                    n2 = t2.stateTransformer,
                    o2 = t2.errorTransformer,
                    i2 = t2.predicate,
                    a2 = t2.logErrors,
                    f2 = t2.diffPredicate;
                ...
                return function (e3) {
                    ...
                    return function (e4) {
                        return function (l2) {
                            ...
                            u2.push(c2),
                                (c2.started = O.now()),
                                (c2.startedTime = /* @__PURE__ */ new Date()),
                                (c2.prevState = n2(r3())),
                                (c2.action = l2);
                            var s2 = void 0;
                            if (a2)
            ...
            (k =
                ...
                Object.defineProperties(c, {
                    diff: { value: c, enumerable: true },
                    observableDiff: { value: l, enumerable: true },
                    applyDiff: { value: h, enumerable: true },
                    applyChange: { value: d, enumerable: true },
                    revertChange: { value: g, enumerable: true },
                    isConflict: {
                        value: function () {
            ...
            var F = {
                ...
                T = function () {
                    var e2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        t2 = e2.dispatch,
                        r2 = e2.getState;
                    return 'function' == typeof t2 || 'function' == typeof r2
                        ? S()({ dispatch: t2, getState: r2 })
                        : void console.error(
