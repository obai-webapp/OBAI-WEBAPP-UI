'use client';
import { require_react } from './chunk-JBG67EE7.js';
import { __toESM } from './chunk-UV5CTPV7.js';
        ...
        return (
                ...
                const t2 = f2.current,
                    ...
                    n2 = (o2) => {
                        o2.target === f2.current &&
                            ...
                            0 === T2.current && 'animationcancel' !== o2.type && t2.classList.remove(...e4));
                    };
                t2.classList.add(...e4),
            ...
            (0, import_react.useEffect)(() => {
                ...
                h2 ||
                    (p2
                        ? e4()
                        : ((T2.current = 1), (t2.className += ` ${v2}`), t2.addEventListener('animationend', e4)));
            }, [h2]),
            import_react.default.createElement(import_react.default.Fragment, null, u2)
        );
    };
}
function y(t2, e2) {
    ...
    function L2(t3, n2) {
        ...
        if (
            ...
            (function (t4) {
                return (
                    !g2.current ||
                    (C2.props.enableMultiContainer && t4.containerId !== C2.props.containerId) ||
        ...
        const M2 = {
            ...
            autoClose:
                !i2.isLoading &&
                ((R2 = i2.autoClose), (w2 = b3.autoClose), false === R2 || (u(R2) && R2 > 0) ? R2 : w2),
            deleteToast() {
                const t4 = y(h2.get(l3), 'removed');
                h2.delete(l3), v.emit(4, t4);
                const e2 = C2.queue.length;
                if (
                    ((C2.count = null == l3 ? C2.count - C2.displayedToast : C2.count - 1),
        ...
        (M2.iconOut = (function (t4) {
            ...
            false === i2.closeButton || f(i2.closeButton)
                ...
                : true === i2.closeButton && (M2.closeButton = !f(b3.closeButton) || b3.closeButton);
        let x2 = t3;
        (0, import_react.isValidElement)(t3) && !d(t3.type)
            ? (x2 = (0, import_react.cloneElement)(t3, { closeToast: L3, toastProps: M2, data: T3 }))
...
function _(t2) {
    const [o2, a2] = (0, import_react.useState)(false),
        ...
        { autoClose: m2, pauseOnHover: f2, closeToast: g2, onClick: h2, closeOnClick: y2 } = t2;
    function v2(e2) {
        if (t2.draggable) {
            ...
            (u2.canCloseOnClick = true),
                ...
                'x' === t2.draggableDirection
                    ? ((u2.start = u2.x), (u2.removalDistance = n2.offsetWidth * (t2.draggablePercent / 100)))
                    : ((u2.start = u2.y),
                      (u2.removalDistance =
                          n2.offsetHeight *
                          (80 === t2.draggablePercent ? 1.5 * t2.draggablePercent : t2.draggablePercent / 100)));
        }
    }
    function T2(e2) {
        if (u2.boundingRect) {
    ...
    function _2(e2) {
        ...
        u2.canDrag &&
            ...
            (u2.x = b(e2)),
            (u2.y = I(e2)),
            (u2.delta = 'x' === t2.draggableDirection ? u2.x - u2.start : u2.y - u2.start),
    ...
    (0, import_react.useEffect)(() => {
        ...
        (0, import_react.useEffect)(
            () => (
                ...
                p(t2.onOpen) && t2.onOpen((0, import_react.isValidElement)(t2.children) && t2.children.props),
                () => {
                    const t3 = d2.current;
        ...
        (0, import_react.useEffect)(
            () => (
                ...
                () => {
                    t2.pauseOnFocusLoss &&
                        (window.removeEventListener('focus', E2), window.removeEventListener('blur', C2));
                }
            ),
            [t2.pauseOnFocusLoss]
        );
...
function O(e2) {
    ...
    const v2 = clsx_m_default(
            ...
            u2 ? 'Toastify__progress-bar--controlled' : 'Toastify__progress-bar--animated',
...
var N = (n2) => {
    ...
    return (
        ...
        import_react.default.createElement(
            y2,
            { isIn: P2, done: k2, position: v2, preventExitTransition: s2, nodeRef: r3 },
            import_react.default.createElement(
                'div',
...
var k = (0, import_react.forwardRef)((e2, n2) => {
    ...
    function f2(t2) {
        const e3 = clsx_m_default('Toastify__toast-container', `Toastify__toast-container--${t2}`, {
